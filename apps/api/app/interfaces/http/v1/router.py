...
from app.interfaces.http.v1.borrowing.router import router as borrowing_router
...
from app.interfaces.http.v1.resources.router import router as resources_router
...
api_router.include_router(borrowing_router, tags=["borrowing"])  # 物资借用申请、审批和归还接口
...
api_router.include_router(resources_router, tags=["resources"])  # 物资资源、分类和库存维护接口
